...
Research Internship Project | Indian Institute of Technology Indore (IITI), Simrol, Indore (M.P.)
...
/Daemon: Daemon software developed for Malware Analysis

/Process Manager: GUI Malwre Analysis application
